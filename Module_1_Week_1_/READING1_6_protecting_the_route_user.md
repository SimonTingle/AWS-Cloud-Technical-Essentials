...
External Site:
 AWS: Enabling a Hardware MFA Device (Console) 

External Site:
 AWS: Enabling a U2F Security Key (Console) 

External Site:
 AWS: Enabling a Virtual Multi-Factor Authentication (MFA) Device (Console) 

External Site:
 AWS: Table of Supported MFA Devices 

External Site: 
Tasks that require the use of root user credentials  
